...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [BASE] = {
  ...
  { TT(F_KEYS),    KC_CAPS, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_BSPC, KC_SPC, KC_SPC,  KC_RGUI, KC_RALT, TT(F_SCROLL), KC_LEFT, KC_DOWN, KC_RGHT },
 },
 ...
 [F_KEYS] = {
  ...
  { _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,      _______, _______, _______ },
  { _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,      _______, _______, _______ },
  { TT(F_KEYS), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, TT(F_SCROLL), _______, _______, _______ },
 },
 ...
 [F_SCROLL] = {
  ...
  { _______,    _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______,      _______, _______, _______ },
  { TT(F_KEYS), RESET,   _______, _______,   _______, _______, _______, _______, _______, _______, _______, TT(F_SCROLL), _______, _______, _______ },
 },
};
